  ...
  return (
    ...
    >
      <motion.img
        ...
        className="h-52 md:h-64 w-auto object-contain mb-14"
  ...
  return (
    <>
      ...
      <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-500 ${scrolled ? "bg-[#060606]/95 backdrop-blur-md" : ""}`}>
        <div className="max-w-[1280px] mx-auto px-6 lg:px-12 flex items-center justify-between h-[130px] md:h-[100px]">
